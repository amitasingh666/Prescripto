...
const About = () => {
  return (
    <div style={{marginTop:45, marginLeft:65}}>
      <div className='text-center text-2xl pt-10 text-gray-500'>
        <p>ABOUT <span className='text-gray-700 font-medium'>US</span></p>
      </div>

      <div className='my-10 flex flex-col md:flex-row gap-12' style={{marginTop:25, marginLeft:55}}>
      ...
      <div className='text-xl my-4' style={{marginTop:25, marginLeft:55}}>
