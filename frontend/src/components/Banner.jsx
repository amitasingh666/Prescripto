...
const Banner = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-blue-500 rounded-lg px-6 sm:px-10 md:px-14 lg:px-20 my-20 mx-8 items-center min-h-[320px] lg:min-h-[500px] overflow-hidden" style={{marginLeft:90, marginRight:90}}>
      {/* Left Side */}
